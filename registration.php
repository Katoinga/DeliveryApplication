...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
	...
	elseif(strlen($_POST['phone']) < 9)  //cal phone length
	{
                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="text" name="lastname" id="example-text-input-2" placeholder=" Apellidos">
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Email</label>
                                       <input type="text" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email"> <small id="emailHelp" class="form-text text-muted"></small>
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Numero de Telefono</label>
                                       <input class="form-control" type="text" name="phone" id="example-tel-input-3" placeholder="Numero de Telefono"> <small class="form-text text-muted"></small>
                                    </div>
                                    <div class="form-group col-sm-6">
