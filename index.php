...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							{
								echo '<li class="nav-item"><a href="login.php" class="nav-link active">Inicia sesión</a> </li>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/fondo.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Escoge un resturant</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Ordena tu pedido</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Espera el envio</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Comidas populares del mes</h2>
                    <p class="lead">Escoge tu plato favorito </p>
                </div>
                <div class="row">
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>Tu comida favorita en solo tres pasos</h2>
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Escoge el o los platos de tu preferencia</h3>
                                <p>Todos los restaurants nos proveen de los mejores platos </p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Espera el envio</h3>
                                <p>Uno de nuestros colaboradores se encargara de llevar tu pedido</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info"> * Paga en efectivo cuando llegue el delivery</p>
                    </div>
                </div>
            </div>
        </section>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min S/15,00</div>
