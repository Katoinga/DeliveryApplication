																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																			...
																			{
																			?>
																			<td> <button type="button" class="btn btn-warning" style="font-weight:bold;"><span class="fa fa-bars"  aria-hidden="true" >Dispatch</button></td>
																		   <?php 
																			  }
																			...
																			?>
																						<?php																									
																							...
																							?>
																								...
																								<?php
																								echo '<a href="view_order.php?user_upd='.$rows['o_id'].'" " class="btn btn-danger btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td>
																									</tr>';
